...
class _DriverRegistrationFormState extends State<DriverRegistrationForm> {
  ...
  Future<void> _sendOtp() async {
    ...
    developer.log('🚀 Sending OTP for driver registration to: $phone', name: 'DriverRegistration');
  ...
  Future<void> _registerDriver() async {
    ...
    developer.log('🚀 Registering driver...', name: 'DriverRegistration');
    ...
    try {
      ...
      if (response.success) {
        developer.log('✅ Driver registration successful', name: 'DriverRegistration');
        
        // Save additional driver details to profile
        final user = response.data;
        developer.log('User data: ${user.toString()}', name: 'DriverRegistration');
      ...
      developer.log('❌ Registration error: $e', name: 'DriverRegistration');
