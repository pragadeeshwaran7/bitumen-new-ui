  ...
  Widget build(BuildContext context) {
    return Consumer<AuthService>(
      builder: (context, authService, child) {
        ...
        // Placeholder data - replace this with API response later
        final String company = "ABC Logistics"; // TODO: Fetch from profile service
        final String address = "Mumbai, Maharashtra"; // TODO: Fetch from profile service
